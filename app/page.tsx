        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 p-4">
            <div className="mx-auto max-w-[1600px]">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                    <div>
                        <label className="block mb-1 font-medium text-black" htmlFor="instanceSelect">
                            인스턴스
                        </label>
                        <select
                            id="instanceSelect"
                            className="border border-gray-300 rounded px-3 py-2 focus:outline-none text-black"
                            value={selectedId}
              ...
              오늘({today}) 로그가 이미 추출되었습니다.
                ...
                {selectedDate ? (
                    <div className="bg-white shadow p-4 rounded">
                        ...
                        <button onClick={handleBackToDates} className="text-blue-600 underline mb-2">
                            ← 날짜 목록으로
                        </button>
                        {exceptionsForDate.length > 0 ? (
                            <div className="overflow-auto">
                                <table className="w-full text-xs border-collapse">
                                    ...
                                    <tr className="bg-gray-200 border-b">
                                        <th className="p-2 text-left text-black">Line No</th>
                                        <th className="p-2 text-left text-black">Exception Message</th>
                                        <th className="p-2 text-left text-black">상세</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    {exceptionsForDate.map((ex) => (
                                        <tr key={ex.id} className="border-b">
                                            <td className="p-2 text-black">{ex.lineNo}</td>
                                            ...
                                            <td className="p-2">
                                                <button
                                                    ...
                                                    className="border border-gray-400 rounded px-2 py-1 hover:bg-gray-100 text-black"
                                                >
                                                    보기
                                                </button>
                                            </td>
                            ...
                            <p className="text-black">해당 날짜에 예외가 없습니다.</p>
                        )}
                    </div>
                ) : dates.length > 0 ? (
                    <div className="bg-white shadow p-4 rounded">
                        <h2 className="text-xl font-semibold mb-2 text-black">이전 로그 목록</h2>
                        <div className="overflow-auto">
                            <table className="w-full text-xs border-collapse">
                                <thead>
                                <tr className="bg-gray-200 border-b">
                                    <th className="p-2 text-left text-black">날짜 (YYYYMMDD)</th>
                                    <th className="p-2 text-left text-black">예외 목록</th>
                                </tr>
                                </thead>
                                <tbody>
                                {dates.map((date) => (
                    ...
                    <p className="text-black mt-4">아직 추출된 로그가 없습니다.</p>
                )}
            </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex-none border-b p-4">
                            <h3 className="text-xl font-semibold text-black">예외 상세</h3>
                        ...
                        {/* 중간(스크롤 영역) */}
                        <div className="flex-grow overflow-auto p-4 text-sm text-black" ref={contentRef}>
                            <div className="mb-2">
                                <b>preLines:</b>
